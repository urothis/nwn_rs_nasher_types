...
/// Represents the UTC (Creature) structure.
#[derive(Debug, Serialize, Deserialize)]
pub struct Utc {
  /// The appearance type of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Appearance_Type")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Cha")]
  pub charisma: Option<NwValue<u8>>,

  /// The challenge rating of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "ChallengeRating")]
  pub challenge_rating: Option<NwValue<Decimal>>,

  /// The list of classes associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "ClassList")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Con")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Dex")]
  pub dexterity: Option<NwValue<u8>>,

  /// Indicates whether the creature is disarmable.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Disarmable", with = "bool_as_u8")]
  pub disarmable: Option<NwValue<bool>>,

  /// The list of equipped items associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Equip_ItemList")]
  pub equip_item_list: Option<NwValue<Vec<EquippedItem>>>,

  /// The faction ID associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "FactionID")]
  pub faction_id: Option<NwValue<u16>>,

  /// The list of feats associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "FeatList")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "fortbonus")]
  pub fortitude_bonus: Option<NwValue<i16>>,

  /// The gender of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Gender")]
  pub gender: Option<NwValue<u8>>,

  /// The alignment (good/evil) of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "GoodEvil")]
  pub good_evil: Option<NwValue<u8>>,

  /// The total hit points of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "HitPoints")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Interruptable")]
  pub interruptable: Option<NwValue<u8>>,

  /// Indicates whether the creature is immortal.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "IsImmortal", with = "bool_as_u8")]
  pub is_immortal: Option<NwValue<bool>>,

  /// Indicates whether the creature is a player character (PC).
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "IsPC", with = "bool_as_u8")]
  pub is_pc: Option<NwValue<bool>>,

  /// The list of items associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "ItemList")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "LawfulChaotic")]
  pub lawful_chaotic: Option<NwValue<u8>>,

  /// Indicates whether the creature is lootable.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Lootable", with = "bool_as_u8")]
  pub lootable: Option<NwValue<bool>>,

  /// The maximum hit points of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "MaxHitPoints")]
  pub max_hit_points: Option<NwValue<i16>>,

  /// The natural armor class of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "NaturalAC")]
  pub natural_ac: Option<NwValue<u8>>,

  /// Indicates whether the creature is not subject to permanent death.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "NoPermDeath", with = "bool_as_u8")]
  pub no_perm_death: Option<NwValue<bool>>,
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "PerceptionRange")]
  pub perception_range: Option<NwValue<u8>>,

  /// The phenotype ID associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Phenotype")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Tail_New")]
  pub tail_new: Option<NwValue<u32>>,

  /// The list of templates associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "TemplateList")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "willbonus")]
  pub will_bonus: Option<NwValue<i16>>,

  /// The new wings ID associated with the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Wings_New")]
  pub wings_new: Option<NwValue<u32>>,

  /// The wisdom attribute value of the creature.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Wis")]
...
pub struct MemorizedSpell {
  ...
  /// Spell value
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Spell")]
  pub spell: Option<NwValue<u16>>,

  /// Spell flags
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "SpellFlags")]
  pub flags: Option<NwValue<u16>>,

  /// Spell meta-magic value
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "SpellMetaMagic")]
...
pub struct Item {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "InventoryRes")]
  pub res_ref: Option<NwValue<String>>,

  /// X-coordinate for the position in the repository
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Repos_PosX")]
  pub repos_pos_x: Option<NwValue<u16>>,

  /// Y-coordinate for the position in the repository
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Repos_Posy")]
...
pub struct EquippedItem {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "EquippedRes")]
  pub res_ref: Option<NwValue<String>>,
}
...
pub struct Feat {
  ...
  /// Feat value
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Feat")]
...
pub struct Skill {
  ...
  /// Skill rank value
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Rank")]
