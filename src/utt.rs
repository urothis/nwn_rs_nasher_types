...
pub struct Utt {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "TrapOneShot")]
  pub trap_one_shot: Option<NwValue<u8>>,

  /// Trap type of the trigger.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "TrapType", with = "bool_as_u8")]
  pub trap_type: Option<NwValue<bool>>,
