...
pub struct Entry {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Animation")]
  pub animation: Option<NwValue<u32>>,

  /// Field representing the animation loop of the entry
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "AnimLoop")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Speaker")]
...
pub struct ReplyEntry {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "LinkComment")]
...
pub struct EntryReply {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Active")]
  pub active: Option<NwValue<String>>,

  /// Field representing the index
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Index")]
  pub index: Option<NwValue<u32>>,

  /// Field indicating if it is a child entry
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "IsChild", with = "bool_as_u8")]
  pub is_child: Option<NwValue<bool>>,
...
pub struct Reply {
  ...
  /// Field indicating if it is a child entry
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "IsChild")]
