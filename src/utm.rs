...
pub struct Utm {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "BlackMarket", with = "bool_as_u8")]
  pub black_market: Option<NwValue<bool>>,

  /// Represents the black market mark down field in the Utm struct.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "BM_MarkDown")]
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "MarkDown")]
  pub mark_down: Option<NwValue<i32>>,

  /// Represents the MarkUp field in the Utm struct.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "MarkUp")]
  pub mark_up: Option<NwValue<i32>>,

  /// Represents the OnOpenStore field in the Utm struct.
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "OnOpenStore")]
...
pub struct Item {
  ...
  #[serde(default, skip_serializing_if = "Option::is_none", rename = "Infinite", with = "bool_as_u8")]
  pub infinite: Option<NwValue<bool>>,
